        ...
        <AnimatePresence mode="wait">
          <motion.div key={current} initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -30 }} transition={{ duration: 0.5 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild size="lg" className="bg-primary/30 backdrop-blur-xl border border-primary-foreground/20 text-primary-foreground hover:bg-primary/50 hover:border-accent/40 rounded-xl px-8 py-6 text-base shadow-[0_0_20px_rgba(0,0,0,0.2)] transition-all group">
                <Link to="/services">
