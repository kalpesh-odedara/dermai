...
const stats = [
  ...
  { icon: Award, value: 200, suffix: "+", label: "Certified Dermatologists" },
  { icon: Clock, value: 25, suffix: "+", label: "Years of Excellence" },
  { icon: Building2, value: 15, suffix: "", label: "Premium Clinics" },
];
