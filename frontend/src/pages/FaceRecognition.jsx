...
const FaceRecognition = () => {
    ...
    const captureAndAnalyze = async () => {
        ...
        try {
            ...
            // Use smart mood detection (aggregates by mood category, excludes neutral)
            const moodResult = determineMood(result.expressions);
            console.log("🎯 Mood analysis:", moodResult);
            console.log("📊 Raw expressions:", result.expressions);

            setCurrentMood(moodResult.mood);
            setConfidence(moodResult.confidence);

            setHistory((prev) => [
                { mood: moodResult.mood, confidence: moodResult.confidence, time: new Date() },
                ...prev.slice(0, 9),
            ]);
        } catch (e) {
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground max-w-xl mx-auto text-lg">
                            Analyze your mood in real-time using advanced facial expression AI.
                            Simply look at the camera and let our model detect how you feel.
                        </p>
                    </motion.div>
                                        ...
                                        {history.map((h, i) => {
                                            ...
                                            return (
                                                <motion.div
                                                    ...
                                                    className="flex items-center gap-2 bg-muted/30 rounded-xl px-4 py-2 border border-border"
                                                >
                        ...
                        >
                                ...
                                {activeMood ? (
                                    ...
                                    >
                                        <div
                                            ...
                                            style={{
                                                background: `linear-gradient(135deg, ${activeMood.gradientFrom}22, ${activeMood.gradientTo}11)`,
                                            }}
                                        >
                                            <motion.div
                                            ...
                                            <p className="text-muted-foreground text-sm">Mood Detected</p>
                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="h-2 bg-muted rounded-full overflow-hidden">
                                                    <motion.div
                                                        ...
                                                        style={{ background: `linear-gradient(90deg, ${activeMood.gradientFrom}, ${activeMood.gradientTo})` }}
                                                        initial={{ width: 0 }}
                                                ...
                                                <div className="space-y-2">
                                                    {activeMood.tips.map((tip, i) => (
                                                        <motion.div
                                                            ...
                                                            className="flex items-start gap-2 bg-muted/30 rounded-xl px-4 py-3 border border-border"
                                                        >
                                                            <Zap className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" style={{ color: activeMood.color }} />
                                                            <span className="text-xs font-medium text-foreground/80">{tip}</span>
                                                        </motion.div>
                                                    ))}
                                                </div>
                                            </div>
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-muted-foreground mb-6">
                                            Start the camera, position your face, and click <strong>"Capture & Analyze"</strong> to detect your mood.
                                        </p>
                                        <div className="grid grid-cols-2 gap-3">
                                            {Object.values(MOOD_DATA).map((m) => (
                                                <div
                                                    key={m.label}
                                                    className="flex items-center gap-2 bg-muted/30 rounded-xl px-3 py-2 border border-border"
                                                >
                            ...
                            <div className="bg-card border border-border rounded-3xl p-6">
                                ...
                                <p className="text-xs text-muted-foreground leading-relaxed">
                                    ...
                                    No images or video are uploaded to any server.
                            ...
                            <div className="bg-card border border-border rounded-3xl p-6">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        { step: "3", text: "Expression is mapped to a mood category" },
                                        { step: "4", text: "Personalized wellness tips are provided" },
                                    ].map((item) => (
