...
import { Heart, Brain, Baby, Bone, Stethoscope, Eye, ArrowRight, X, CheckCircle } from "lucide-react";
    ...
    return (<Layout>
       ...
       <AnimatePresence>
         {selectedService && (<>
             ...
             <motion.div initial={{ opacity: 0, scale: 0.9, y: 50 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9, y: 50 }} className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-lg bg-card rounded-3xl p-8 shadow-2xl z-50">
