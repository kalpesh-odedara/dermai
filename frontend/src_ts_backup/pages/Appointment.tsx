 ...
 import { 
   User, Calendar, Clock, Stethoscope, 
       ...
       <Layout>
         <section className="min-h-[80vh] flex items-center justify-center py-20">
           ...
           >
             ...
             <Button 
               onClick={() => { setSubmitted(false); setCurrentStep(1); setFormData({ firstName: "", lastName: "", email: "", phone: "", department: "", doctor: "", date: "", time: "", reason: "" }); }}
             ...
             {steps.map((step, index) => (
               <div key={step.id} className="flex items-center">
                 ...
                 {index < steps.length - 1 && (
                   <div
                     className={`w-12 sm:w-24 lg:w-32 h-1 mx-2 rounded-full transition-all duration-300 ${
