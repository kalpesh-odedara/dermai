         ...
         <div className="container mx-auto px-4 lg:px-8">
           ...
           >
             ...
             <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
               Caring for Life, <span className="text-accent">Healing with Heart</span>
             </h1>
             <p className="text-muted-foreground text-lg md:text-xl">
               For over 25 years, we've been at the forefront of healthcare innovation, 
               providing world-class medical services with compassion and excellence.
             </p>
           </motion.div>
         </div>
       </section>
         ...
         <div className="container mx-auto px-4 lg:px-8">
           <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
             ...
             <div className="relative h-[500px] lg:h-[600px]">
               <motion.div
                 style={{ y: y1 }}
                 className="absolute top-0 left-0 w-3/4 h-3/4 rounded-3xl overflow-hidden shadow-2xl"
               >
                 <img
                   src={aboutDoctor}
               ...
               <motion.div
                 style={{ y: y2 }}
                 className="absolute bottom-0 right-0 w-2/3 h-2/3 rounded-3xl overflow-hidden shadow-2xl border-4 border-card"
               >
                 <img
                   src={aboutTeam}
             ...
             <div ref={missionRef}>
               ...
               >
                 ...
                 <p className="text-muted-foreground text-lg mb-6">
                   Founded in 1999, MediCare+ has grown from a small community clinic to a 
                   comprehensive medical center serving thousands of patients annually. Our 
                   commitment to excellence has never wavered.
                 </p>
                 <p className="text-muted-foreground text-lg mb-8">
                   Today, we're proud to offer state-of-the-art facilities, cutting-edge 
                   treatments, and a team of over 200 dedicated healthcare professionals.
                 </p>
 
                 <div className="space-y-4">
                   {["Board-certified physicians", "24/7 Emergency care", "Advanced diagnostics", "Patient-centered approach"].map((item, i) => (
                     <motion.div
                       key={item}
           ...
           <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
             {values.map((value, index) => (
               <motion.div
                 ...
                 className="text-center p-8 rounded-2xl bg-card border border-border hover:border-accent/50 hover:shadow-xl transition-all duration-300"
               >
