         ...
         {isOpen && (
           <>
             <motion.div
               ...
               animate={{ opacity: 1 }}
               exit={{ opacity: 0 }}
               className="fixed inset-0 bg-primary/20 backdrop-blur-sm lg:hidden z-40"
             ...
             <motion.div
               ...
               className="fixed top-0 right-0 bottom-0 w-80 bg-card border-l border-border shadow-2xl lg:hidden z-50"
             >
